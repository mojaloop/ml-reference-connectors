...
export class CoreConnectorAggregate {
    ...
    private validateConversionTerms(transferResponse: TSDKOutboundTransferResponse): TValidationResponse {
        ...
        if (
            ...
            result = false;
            message.push(`this.mtnConfig.MTN_ENV ${this.mtnConfig.MTN_ENV} did not equal transferResponse.fxQuotesResponse?.body.conversionTerms.sourceAmount.currency ${transferResponse.fxQuotesResponse?.body.conversionTerms.sourceAmount.currency}`);
        }
        if (transferResponse.amountType === 'SEND') {
            ...
            if (!(transferResponse.amount === transferResponse.fxQuotesResponse?.body.conversionTerms.sourceAmount.amount)) {
                result = false;
                message.push(`transferResponse.amount ${transferResponse.amount} did not equal transferResponse.fxQuotesResponse?.body.conversionTerms.sourceAmount.amount ${transferResponse.fxQuotesResponse?.body.conversionTerms.sourceAmount.amount}`);
            }
            ...
            if (!(transferResponse.currency === transferResponse.fxQuotesResponse?.body.conversionTerms.sourceAmount.currency)) {
                result = false;
                message.push(`transferResponse.currency ${transferResponse.currency} did not equal transferResponse.fxQuotesResponse?.body.conversionTerms.sourceAmount.currency ${transferResponse.fxQuotesResponse?.body.conversionTerms.sourceAmount.currency} `);
            }
            ...
            if (!(transferResponse.amount === transferResponse.fxQuotesResponse?.body.conversionTerms.targetAmount.amount)) {
                result = false;
                message.push(`transferResponse.amount ${transferResponse.amount} did not equal transferResponse.fxQuotesResponse?.body.conversionTerms.targetAmount.amount ${transferResponse.fxQuotesResponse?.body.conversionTerms.targetAmount.amount}`);
            }
    ...
    private validateReturnedQuote(transferResponse: TSDKOutboundTransferResponse): TValidationResponse {
        ...
        if (transferResponse.amountType === "SEND") {
            const quoteRequestAmount: string = transferResponse.fxQuotesResponse?.body?.conversionTerms?.targetAmount?.amount ? transferResponse.fxQuotesResponse?.body?.conversionTerms?.targetAmount?.amount : transferResponse.amount;
