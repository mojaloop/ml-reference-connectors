...
): THttpResponse<TSDKOutboundTransferResponse> => ({
    statusCode: 200,
    data: {
...
export const getTransfersResponseDTO = (
...
export const getSDKOutboundTransferRequestDTO = (): TSDKOutboundTransferRequest => ({
